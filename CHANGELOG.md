...
### Added
- `EditRegion.topOnly`, `EditRegion.bottomOnly`, `EditRegion.leftOnly` and
  `EditRegion.rightOnly` const convenience constructors for single-edge
  regions.

## [1.0.3] - 2026-05-13

### Changed
- Replaced the deprecated `library fast_image_editor;` directive with
